...
public class Hunter : MonoBehaviour
{
    ...
    private static float currentRespawnDelay = 30f;
    private static float currentChaseSpeed = 5f;
    private static int currentAttackDamage = 15;
    ...
    [SerializeField] private float initialRespawnDelay = 30f;
    ...
    [SerializeField] private float chaseSpeedIncrease = 0.2f;
    [SerializeField] private int initialAttackDamage = 15;
    [SerializeField] private int attackDamageIncrease = 3;
